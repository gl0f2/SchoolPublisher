...
class ElternabendHtmlRenderer:
    ...
    def rendern(
        ...
        for fachname in sortierte_fachnamen:
            ...
            ist_doppelkarte = (
                (klasse_key.startswith("10") and fach_key in {"imp", "sport (profil)"})
                or (klasse_key == "5b" and fach_key == "religion (ev.)")
                or (klasse_key in {"8e", "8f"} and fach_key == "sport (profil)")
                or (klasse_key == "8f" and fach_key == "französisch")
                or (klasse_key == "9b" and fach_key == "französisch")
                or (klasse_key == "9f" and fach_key == "sport (profil)")
                or (klasse_key == "10b" and fach_key == "französisch")
            )
            kompakter_kopf = (
