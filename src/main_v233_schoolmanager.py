"""SchoolPublisher Version 2.3.3 - Schoolmanager A/B."""
...
def main() -> None:
    print("=" * 60)
    print("SchoolPublisher Version 2.3.3 - Schoolmanager A/B")
    print("=" * 60)
    ...
    try:
        ...
        print("=" * 60)
        print("SchoolPublisher Version 2.3.3 erfolgreich beendet.")
        print("=" * 60)
