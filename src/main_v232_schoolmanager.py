"""SchoolPublisher Version 2.3.2 - Schoolmanager A/B."""
...
def main() -> None:
    print("=" * 60)
    print("SchoolPublisher Version 2.3.2 - Schoolmanager A/B")
    print("=" * 60)
    ...
    try:
        ...
        lehrkraeftekatalog = SchoolmanagerLehrkraefteImporter(
            SCHOOLMANAGER_DATEN_DIR,
            LEHRKRAEFTE_FILE,
        ).load()
        print(f"✓ Lehrkräfte aus Schoolmanager + lokalen Zusatzdaten: {len(lehrkraeftekatalog)} Lehrkräfte")
        ...
        print("=" * 60)
        print("SchoolPublisher Version 2.3.2 erfolgreich beendet.")
        print("=" * 60)
